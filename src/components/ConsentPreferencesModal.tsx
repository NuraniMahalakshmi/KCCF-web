      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        <div className="w-full max-w-lg rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-2xl overflow-hidden">
          <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-800">
            ...
            <button onClick={closePreferences} className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none hover:cursor-pointer" aria-label="Close preferences">
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="pt-2 text-sm text-gray-600 dark:text-gray-400">
              Read our <a href="/privacy" className="underline hover:no-underline">Cookie Policy</a> for details.
            </div>
          </div>
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-800 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div className="flex gap-2">
              <button ref={initialFocusRef} type="button" onClick={rejectAll} className="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 hover:cursor-pointer">Reject all</button>
            ...
            <div className="flex gap-2">
              <button type="button" onClick={closePreferences} className="px-4 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 hover:cursor-pointer">Cancel</button>
